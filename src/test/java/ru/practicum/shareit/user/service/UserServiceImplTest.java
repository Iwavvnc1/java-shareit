...
class UserServiceImplTest {
    ...
    void create() {
        ...
        assertEquals(returnUser, userService.create(user));
    ...
    void update_whenInvokedUpdateNameAndEmail_thenReturnUpdateUser() {
        ...
        assertEquals(returnUser, userService.update(userId, newUser));
    ...
    void update_whenInvokedUpdateEmail_thenReturnUpdateUser() {
        ...
        when(userRepository.findById(userId)).thenReturn(Optional.of(oldUser));
        when(userRepository.save(newUser)).thenReturn(newUser);
        UserDto savedUser = userService.update(userId, newUser);
