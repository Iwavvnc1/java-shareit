...
class ItemRequestControllerTest {
    ...
    void create() {
        ...
        when(itemRequestService.create(userId, itemRequest)).thenReturn(returnRequest);
        ResponseEntity<ItemRequestCreateDto> response = itemRequestController.create(userId, itemRequest);
        assertEquals(OK, response.getStatusCode());
        assertEquals(returnRequest, response.getBody());
    }
}