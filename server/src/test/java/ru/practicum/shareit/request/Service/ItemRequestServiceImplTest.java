...
class ItemRequestServiceImplTest {
    ...
    void create_whenInvoked_thenReturnRequest() {
        ...
        ItemRequestCreateDto itemRequest2 = ItemRequestCreateDto.builder()
        ...
        ItemRequestCreateDto itemRequestCreateDto = itemRequestService.create(userId, itemRequest2);
    ...
    void create_whenInvokedWithFailedUser_thenReturnException() {
        ...
        assertThrows(NotFoundException.class, () -> itemRequestService.create(userId, itemRequest2));
